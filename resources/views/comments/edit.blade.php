        ...
        <div class="card-container">
            <div class="card-post">
                ...
                <div class="card-footer">
                    <div class="tags">
                        <ul>
                            <li class="tag">movie</li>
                            <li class="tag">anime</li>
                            <li class="tag">r13</li>
                        </ul>
                    </div>
                    <div class="likes">
                        ...
                        <div class="comment-box">
                            <div class="comment-header">
                                <div class="comment-author">
                                    <img src="{{ asset('storage/' . ($comment->user->profile?->image ?? 'default.jpg')) }}" alt="" width="40px" height="40px">
                                    <p>{{ $comment->user['firstname'] . ' ' . $comment->user['lastname'] }}</p>
                                </div>
                                <div class="comment-actions">
                                    @if (Auth::id() === $comment->user_id)
                                        <a href="{{ route('comments.edit', $comment->id) }}" class="edit-icon"> <i class="fa fa-edit"></i> </a>
